...
- Break down changes into small, logical commits unless the user specifies otherwise
- Prefer multiple focused commits over one large commit

## Workflow

Always follow this process when committing:

1. Analyze the changes to be committed
2. Propose commit message(s) to the user for approval
3. Wait for user confirmation before proceeding
4. Execute commit(s) only after approval

If multiple commits are needed:
- Propose a breakdown into logical commits
- Show all proposed commit messages
- Wait for user to agree with the breakdown before proceeding
